...
-- RenameIndex
-- This index only exists on some pre-reconciliation local databases. Fresh
-- migration rebuilds create the Unit 52 document page index later.
ALTER INDEX IF EXISTS "ExternalContextDocumentPage_externalContextId_fileIndex_pageNum" RENAME TO "ExternalContextDocumentPage_externalContextId_fileIndex_pag_key";
