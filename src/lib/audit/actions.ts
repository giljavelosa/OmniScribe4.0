...
export type AuditAction =
  ...
  | 'PLATFORM_ORG_RESTORED'
  | 'PLATFORM_USER_RESTORED'
  ...
  | 'EXTERNAL_CONTEXT_BATCH_EXTRACTED'
  | 'EXTERNAL_CONTEXT_BATCH_REVIEWED'
  | 'EXTERNAL_CONTEXT_EXTRACTION_COMPLETED'
  | 'EXTERNAL_CONTEXT_EXTRACTION_FAILED'
  | 'EXTERNAL_CONTEXT_VERIFIED'
  | 'EXTERNAL_CONTEXT_DISCARDED'
